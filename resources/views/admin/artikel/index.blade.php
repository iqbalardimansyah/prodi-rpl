        ...
        <div class="col-12 box-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-2">Tabel Artikel</h4>
                    <a class="btn btn-rounded btn-success" href="{{url('admin/artikel/add')}}">Tambah</a>
                        ...
                        <tbody>
                            @foreach ($articles as $article)
                                <tr>
                                    ...
                                    <td>{{ $article->judul }}</td>
                                    <td>{{ $article->desc }}</td>
                                    <td><img src="{{asset('assets')}}/images/{{ $article->image_path }}" alt=""></td>
                                    <td>
                                        <a href="{{url("/admin/artikel/$article->id_artikel/edit")}}"
                                            class="btn btn-sm btn-warning">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <form action="{{url("/admin/artikel/$article->id_artikel/delete")}}"
                                            method="POST"
