        ...
        <div class="col-12 box-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-rounded btn-success" href="{{url('admin/pengajaran-dosen/add')}}">Tambah</a>
                        ...
                        <tbody>
                            @foreach ($pengajarans as $pengajaran)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url("/admin/pengajaran-dosen/$pengajaran->id_pengajaran/edit")}}"
                                            class="btn btn-sm btn-warning">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <form action="{{url("/admin/pengajaran-dosen/$pengajaran->id_pengajaran/delete")}}"
                                            method="POST"
