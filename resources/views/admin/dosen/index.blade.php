        ...
        <div class="col-12 box-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-2">Tabel Dosen</h4>
                    <a class="btn btn-rounded btn-success" href="{{url('admin/dosen/add')}}">Tambah</a>
                        ...
                        <tbody>
                            @foreach ($dosens as $dosen)
                                <tr>
                                    <td>{{ !empty($i) ? ++$i : $i = 1}}</td>
                                    <td>{{ $dosen->nama }}</td>
                                    <td><img src="{{asset('assets')}}/images/dosen/{{ $dosen->image_path }}" alt="" width="150px"></td>
                                    <td>
                                        <a href="{{url("/admin/dosen/$dosen->id_dosen/edit")}}"
                                            class="btn btn-sm btn-warning">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <form action="{{url("/admin/dosen/$dosen->id_dosen/delete")}}"
                                            method="POST"
